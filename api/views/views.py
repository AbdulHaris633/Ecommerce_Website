...
def add_to_basket(request):
    ...
    for obj in all_products:
        basket.add(obj) 
    return Response({"message": "Products has been added successfully"}, status=status.HTTP_200_OK)
...
def remove_from_basket(request): 
    ...
    return Response({"message": "Products has been delete successfully"}, status=status.HTTP_200_OK) 
